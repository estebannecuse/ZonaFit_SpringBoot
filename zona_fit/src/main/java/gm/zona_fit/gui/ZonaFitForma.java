...
//@Component //con esto conecto todas las clases, puedo injectar dependencias
public class ZonaFitForma extends JFrame{
    ...
    private void createUIComponents() {
        ...
        //evitamos que se pueda dar doble click en la tabla y editarla directamente
    ...
    private void guardarCliente(){
        if(nombreTexto.getText().equals("")){
            ...
            nombreTexto.requestFocusInWindow();  // me lleva al campo de texto de referencia para que el usuario solo escriba
            return;
        }
        if(membresiaTexto.getText().equals("")){
            mostrarMensaje("Ingrese una membresia");
        ...
        // ahora recuperamos valores para guardar
    ...
    private void eliminarCliente(){
        ...
        if(renglon != -1){
            ...
            mostrarMensaje("Cliente cin id: " + this.idCliente+ " eliminado");
            limpiarFormulario();
            listarClientes();
        }else
    ...
    private void mostrarMensaje(String mensaje){
        JOptionPane.showMessageDialog(this, mensaje); // lanza un " alert "
    }
}
